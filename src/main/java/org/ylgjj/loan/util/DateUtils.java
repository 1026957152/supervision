...
/*        Date firstDate = new Date(FIRST);
   ...
   //     System.out.println("____________"+dateString);
        LocalDateTime getBegym_开始年月 = java.time.LocalDateTime.from(formatter.parse(dateString+"01"));
     ...
     */
    public static void getIntervalTimeByMonth(Long startTime, Long endTime, List<DateRange> beginDateList) {
       ...
       // beginDateList.add(calendar.getTimeInMillis());
        while (calendar.getTimeInMillis() < endDate.getTime()) {
          ...
          //  beginDateList.add(calendar.getTimeInMillis());
            ...
            beginDateList.add(DateRange.create(st,en)) ;
        }
