...
public class H10_2逾期监管_逾期监管明细查询 {
    ...
    public String getDkffrq_发放日期_String() {
        return dkffrq_发放日期_String;
    }

    public void setDkffrq_发放日期_String(String dkffrq_发放日期_String) {
        this.dkffrq_发放日期_String = dkffrq_发放日期_String;
    }
    ...
    public int getDqyqcs_当前逾期次数_int() {
        return dqyqcs_当前逾期次数_int;
    }

    public void setDqyqcs_当前逾期次数_int(int dqyqcs_当前逾期次数_int) {
        this.dqyqcs_当前逾期次数_int = dqyqcs_当前逾期次数_int;
    }
    ...
    public String getYqkssj_逾期开始日期_String() {
        return yqkssj_逾期开始日期_String;
    }

    public void setYqkssj_逾期开始日期_String(String yqkssj_逾期开始日期_String) {
