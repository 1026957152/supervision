...
public class S_41_SEQ_外部转出人数_AND_0301004201_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_41_SEQ_外部转出人数_AND_0301004201;
...
*/
        ...
        triplets.stream().forEach(t->{
            ...
            tr100_转移接续登记簿s
                    ...
                    .filter(x->x.getJylx_不可为空_交易类型().equals("2"))  ////_1-转入,2-转出_0:;
