...
@Service
public class S_177_SEQ_结清户数_AND_0302002201_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_177_SEQ_结清户数_AND_0302002201;
    ...
    public void targetHistory(LocalDate beginDateTotal, LocalDate endDateTotal) {
        ...
        ln003_合同信息s
                ...
                .filter(e->e.getClearstate不可为空结清标志().equals(E_LN003_合同信息_结清标志.E_1_正常还清.getText())||
                        e.getClearstate不可为空结清标志().equals(E_LN003_合同信息_结清标志.E_2_提前还清.getText()))

                .collect(Collectors.groupingBy(e->e.getCleardate_结清日期()))
                .entrySet()
                .stream()
