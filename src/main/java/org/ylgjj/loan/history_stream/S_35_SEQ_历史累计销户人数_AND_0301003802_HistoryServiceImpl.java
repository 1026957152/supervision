...
@Service
public class S_35_SEQ_历史累计销户人数_AND_0301003802_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_35_SEQ_历史累计销户人数_AND_0301003802;
    ...
    public void targetHistory(LocalDate beginDateTotal, LocalDate endDateTotal) {
        ...
        List<Triplet<Long,LocalDate,LocalDate>> triplets =
                run统计周期编码(beginDateTotal,endDateTotal,StatisticalIndexCodeEnum.S_35_SEQ_历史累计销户人数_AND_0301003802);
                ...
                return Quartet.with(e,
                    ...
                    .forEach(e -> {
                        ...
                        TargetHistory loanHistory  = new TargetHistory(e.getKey(),
                                StatisticalIndexCodeEnum.S_35_SEQ_历史累计销户人数_AND_0301003802);

                        Long value =e.getValue()
                                .stream()
                                .filter(x->! NativePlace.isYulin(x.getValue3().getCertinum_证件号码()))

                                .filter(x->x.getValue3().getClsaccdate销户日期().equals(beginDate)).count();  //
