...
@Service
public class S_111_SEQ_回收额__正常还清___AND_0302000205_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_112_SEQ_回收额__提前还清___AND_0302000206;
            ...
            ln006__贷款分期还款计划s
                ...
                dimension1.getValue().stream().collect(Collectors.groupingBy(e -> {
                    ...
                    Double value = dimension2.getValue().stream()
                            ...
                            .filter(z->z.getValue0().getInitialbal0期初余额().equals(z.getValue0().getPlanprin0本期应还本金()))
