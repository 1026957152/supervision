...
@Service
public class S_172_SEQ_回收户数__提前还本___AND_0302002104_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_172_SEQ_回收户数__提前还本___AND_0302002104;
    ...
    public void targetHistory(LocalDate beginDateTotal, LocalDate endDateTotal) {
        ...
        ln006_贷款分期还款计划s
                .stream()
                .filter(e->e.getCurseqstate本期状态().equals(E_LN006_贷款分期还款计划_curseqStatusEnum.提前部分.getText()))
                ...
                .forEach(f->{
                    ...
                    Long count_逾期归还 = f.getValue()
                            .stream()
                            .filter(x->x.getCurseqstate本期状态().equals(E_LN006_贷款分期还款计划_curseqStatusEnum.提前部分.getText()))
