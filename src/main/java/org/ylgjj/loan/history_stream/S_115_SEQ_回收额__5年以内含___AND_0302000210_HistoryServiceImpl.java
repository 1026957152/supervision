...
@Service
public class S_115_SEQ_回收额__5年以内含___AND_0302000210_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_115_SEQ_回收额__5年以内含___AND_0302000210;
            ...
            ln006__贷款分期还款计划s
                ...
                dimension1.getValue().stream().collect(Collectors.groupingBy(e -> {
                    ...
                    Double value =dimension2.getValue().stream()
                           // .filter(z->z.getValue2().getLoanterm_贷款期限()> 5*13)
