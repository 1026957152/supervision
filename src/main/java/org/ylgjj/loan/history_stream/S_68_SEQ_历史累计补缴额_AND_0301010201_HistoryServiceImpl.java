...
@Service
public class S_68_SEQ_历史累计补缴额_AND_0301010201_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_68_SEQ_历史累计补缴额_AND_0301010201;
    @Autowired
            ...
            dw145_提取结算登记簿s
                ...
                return Triplet.with(e,
                    ...
                    .forEach(e -> {
                        ...
                        TargetHistory loanHistory  = new TargetHistory(e.getKey(),statisticalIndexCodeEnum);
