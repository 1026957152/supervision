...
@Service
public class S_32_SEQ_新增人数__非本市缴存职工___AND_0301003602_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_32_SEQ_新增人数__非本市缴存职工___AND_0301003602;
...
*/
    ...
    public void targetHistory(LocalDate beginDateTotal, LocalDate endDateTotal) {
        ...
        List<Triplet<Long,LocalDate,LocalDate>> triplets =
                run统计周期编码(beginDateTotal,endDateTotal,StatisticalIndexCodeEnum.S_32_SEQ_新增人数__非本市缴存职工___AND_0301003602);
                ...
                return Quartet.with(e,
                    ...
                    .forEach(e -> {
                        ...
                        TargetHistory loanHistory  = new TargetHistory(e.getKey(),
                                StatisticalIndexCodeEnum.S_32_SEQ_新增人数__非本市缴存职工___AND_0301003602);
