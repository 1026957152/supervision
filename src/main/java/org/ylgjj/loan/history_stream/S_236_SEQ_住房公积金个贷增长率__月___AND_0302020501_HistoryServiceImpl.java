...
//个人住房贷款余额与缴存余额之比
@Service
public class S_236_SEQ_住房公积金个贷增长率__月___AND_0302020501_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_236_SEQ_住房公积金个贷增长率__月___AND_0302020501;
    ...
    public static void main(String[] argus){
        System.out.println("--------"+ Arrays.asList(1,2,3,4,5,6,7));
        Arrays.asList(1,2,3,4,5,6,7).stream().sorted(Comparator.comparingLong(e->-e))
                .forEach(e->{
