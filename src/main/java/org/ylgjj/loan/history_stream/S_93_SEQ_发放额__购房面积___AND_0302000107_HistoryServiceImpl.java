...
@Service
public class S_93_SEQ_发放额__购房面积___AND_0302000107_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_94_SEQ_发放额__单位性质___AND_0302000108;
    ...
    public void 流水_单位缴存spanTimeSpan(LocalDate beginDateTotal, LocalDate endDateTotal) {
        ...
        triplets.stream().forEach(t->{
            ...
            ln003_合同信息s
                ...
                return Pair.with(e,ln014_贷款房屋信息MapAll(null).get(e.getLoanaccnum_贷款账号())
/*                        ln005_贷款分户信息MapAll().get(e.getLoancontrnum_借款合同号()),
                ...
                dimension1.getValue().stream().collect(Collectors.groupingBy(dimension2->dimension2.getValue0().getAgentbankcode_经办银行()))
                    ...
                    dimension2.getValue().stream().collect(Collectors.groupingBy(dimension3->dimension3.getValue1().getTnhousearea不可为空_购房面积()))
