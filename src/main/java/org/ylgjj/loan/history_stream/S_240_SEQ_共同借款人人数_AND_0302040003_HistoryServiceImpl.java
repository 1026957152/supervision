...
@Service
public class S_240_SEQ_共同借款人人数_AND_0302040003_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_240_SEQ_共同借款人人数_AND_0302040003;
                ...
                .forEach(e -> {
                    ...
                    Long value= e.getValue().stream().mapToLong(j->{
                            ...
                            return  j.getValue3().stream()
                                    .filter(x->x.getIndiacctype_1_个人账户类型().equals(E_LN008_借款人信息_借款人类型.共同借款人.getText()))

                                    .filter(x->x.getLoanopchgtype_0_借款人变更类型().equals(E_ln008_借款人信息_借款人变更类型.无.getText()))
                                    .count();
