...
@Service
public class S_13_SEQ_开户总单位数_AND_0301002101_HistoryServiceImpl extends HistoryServiceImpl{

    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_13_SEQ_开户总单位数_AND_0301002101;
                ...
                return Triplet.with(e,
                    ...
                    .forEach(e -> {
                        ...
                        TargetHistory loanHistory  = new TargetHistory(e.getKey(),
                                StatisticalIndexCodeEnum.S_13_SEQ_开户总单位数_AND_0301002101);
