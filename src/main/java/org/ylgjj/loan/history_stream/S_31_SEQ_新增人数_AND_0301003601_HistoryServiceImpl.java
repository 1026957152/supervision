...
@Service
public class S_31_SEQ_新增人数_AND_0301003601_HistoryServiceImpl extends HistoryServiceImpl{
    StatisticalIndexCodeEnum statisticalIndexCodeEnum = StatisticalIndexCodeEnum.S_31_SEQ_新增人数_AND_0301003601;
    ...
    public void targetHistory(LocalDate beginDateTotal, LocalDate endDateTotal) {
        ...
        List<Triplet<Long,LocalDate,LocalDate>> triplets =
                run统计周期编码(beginDateTotal,endDateTotal,StatisticalIndexCodeEnum.S_31_SEQ_新增人数_AND_0301003601);
                ...
                return Quartet.with(e,
                    ...
                    .forEach(e -> {
                        ...
                        TargetHistory loanHistory  = new TargetHistory(e.getKey(),
                                StatisticalIndexCodeEnum.S_31_SEQ_新增人数_AND_0301003601);



                        Long value =e.getValue().stream().filter(x->x.getValue3().getOpnaccdate开户日期().equals(beginDate)).count();
