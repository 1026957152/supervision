 ...
 */
public enum H_DP202_单位缴存变更登记簿_变更类型 {
    E_1_新增个人 ("1", "新增个人",1,""),
    E_2_启封 ("2", "启封",2,""),
...
/*
    ...
    public static H_DP202_单位缴存变更登记簿_变更类型 fromString(String text) {
        for (H_DP202_单位缴存变更登记簿_变更类型 status : H_DP202_单位缴存变更登记簿_变更类型.values()) {
    ...
    public static H_DP202_单位缴存变更登记簿_变更类型 fromInt(Integer text) {
        for (H_DP202_单位缴存变更登记簿_变更类型 status : H_DP202_单位缴存变更登记簿_变更类型.values()) {
