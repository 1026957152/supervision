 ...
 */
public enum E_CM001_单位基本资料表_单位性质 {
...
;
    ...
    public static PaymentUnitTypeEnum_单位性质_建行 from(String text) {
        ...
        E_CM001_单位基本资料表_单位性质 typeEnum = E_CM001_单位基本资料表_单位性质.fromString(text);
        switch (typeEnum){
            case 国家机关:
            case 差额拨款事业单位:
            case 全额拨款事业单位:
    ...
    E_CM001_单位基本资料表_单位性质(String statusText, String displayText, Integer id, String helpMessage) {
...
/*
    ...
    public static E_CM001_单位基本资料表_单位性质 fromString(String text) {
        for (E_CM001_单位基本资料表_单位性质 status : E_CM001_单位基本资料表_单位性质.values()) {
    ...
    public static E_CM001_单位基本资料表_单位性质 fromInt(Integer text) {
        for (E_CM001_单位基本资料表_单位性质 status : E_CM001_单位基本资料表_单位性质.values()) {
