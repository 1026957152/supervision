...
@Service
public class SY_t_154_gtjcjsbs_柜台缴存基数变更笔数_RateServiceImpl extends RateServiceBaseImpl {

    E_指标_RATE_SY e_指标_rate_sy = E_指标_RATE_SY.SY_154_gtjcjsbs_柜台缴存基数变更笔数;
    @Autowired
