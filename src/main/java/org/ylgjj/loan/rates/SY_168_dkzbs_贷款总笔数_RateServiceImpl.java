...
@Service
public class SY_168_dkzbs_贷款总笔数_RateServiceImpl extends RateServiceBaseImpl {

    E_指标_RATE_SY e_指标_rate_sy = E_指标_RATE_SY.SY_168_dkzbs_贷款总笔数;
    @Autowired
    ...
    public RateAnalysisStream history() {
        ...
        List<LN003_合同信息> ln003_合同信息s = ln003_合同信息_repository
                .findByLoandate放款日期BetweenOrderByLoandate放款日期Desc(beginDate,endDate);
...
/*        List<RateHistory> rateHistories_环比 = rateHistoryRepository
        ...
        */
        ...
        h1.setDkzbs_贷款总笔数_NUMBER_18_0(rateHistory);
        h1.setWtdkzbs_网厅贷款总笔数_NUMBER_18_0(rateHistory);
...
Long rateHistory = rateHistories
        ...
        h1.setDkzbs_贷款总笔数_NUMBER_18_0(rateHistory.intValue());
        h1.setWtdkzbs_网厅贷款总笔数_NUMBER_18_0(rateHistory.intValue());
