...
@Service
public class SY_88_ljxkhdws_累计新开户单位_RateServiceImpl extends RateServiceBaseImpl{
    ...
    public void query(H1_2监管主要指标查询_公积金中心主要运行情况查询 h1, String ksrq, String jsrq) {
        ...
        h1.setLjhbxkhdws_累计环比新开户单位_NUMBER_18_0(bigDecimal.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());

        bigDecimal = BigDecimal.valueOf((rateHistory.intValue()-rateHistory_同比.intValue()+0D)/rateHistory_同比.intValue());

        h1.setLjsnxkhdws_累计同比新开户单位_NUMBER_18_0(bigDecimal.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
