...
<div class="container" style="margin-bottom:60px; margin-top:20px">
    ...
    <ol class="breadcrumb">
        <li class="active"><strong>第二步</strong> 建立 司机帐号</li>
    </ol>
        ...
        <div class="tabpanel">
            <ul class="nav nav-tabs " id="ajaxTabs" role="tablist">
                ...
                <li role="presentation " class="active"><a href="#account" aria-controls="account" role="tab"
                                                           data-toggle="tab">注册司机帐号 <span class="badge"></span></a></li>
...
<#--
                                ...
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control " name="license" id="license" placeholder="车牌号" value="">
