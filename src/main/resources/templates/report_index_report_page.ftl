...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="col-md-4">
            <div class="row">
                <div class="col-xs-12">
                    <ul id="news-demo-down-auto" class="news-demo-down-auto">
            ...
            $(function () {
                ...
                $.get("${eventUrl}", function(data){
                 ...
                 //   alert("-------------"+ JSON.stringify(data));
                    //$("#news-demo-down-auto li").remove();

                //    $("#news-demo-down-auto li").not(":first").remove();
                    $.each(data.content, function (i) {

                        $('#news-demo-down-auto').append("<li class='news-item'> " + data.content[i].companyName +" " + data.content[i].description  + " " + data.content[i].createDate +"</li>");
                    });
